    ...
    def zoom(self, whichWay = ZOOM_IN, keepRatio = False):
        ...
        if whichWay == ZOOM_IN:
            if not keepRatio:
                ...
                self.zoomBox.setOutline('lightblue')
...
class DropDown(GraphicsObject):
    ...
    # ADDED BY CARTER HERMAN
    def addChoice(self, choice, canvas, options):
        self.choices.append(choice)
        self._draw(canvas, options)

     # ADDED BY CARTER HERMAN
    def removeChoice(self, choice, canvas, options):
