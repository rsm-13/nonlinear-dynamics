...
class DEGraphWin(tk.Canvas):
    ...
    def setAxisType(self, axisType):
        ...
        if axisType in [0,1]:
            self.axisType = axisType
        self.updateAxes(self.axisType, self.axisStylel)
    ...
    def zoom(self, winControl, whichWay = ZOOM_IN, keepRatio = False):
...
class _BBox(GraphicsObject):
    ...
    def __init__(self, p1, p2, radius=None, options=["outline","width","fill"]):
...
class Rectangle(_BBox):
    def __init__(self, p1, p2):
        _BBox.__init__(self, p1, p2, radius=0)
...
class RoundedRectangle(_BBox):
    def __init__(self, p1, p2, radius):
        _BBox.__init__(self, p1, p2, radius)
    
    def __repr__(self):
        return "Rounded Rectangle({}, {})".format(str(self.p1), str(self.p2))
    ...
    def _draw(self, canvas, options):
        ...
        return canvas.create_polygon(points, options, smooth=True)
...
class Line(_BBox):
    def __init__(self, p1, p2, radius=None,style='solid'):
        _BBox.__init__(self, p1, p2, radius, ["arrow","fill","width"])
...
class Text(GraphicsObject):
    ...
    def __init__(self, p, text, face=None, color=None, size=None):
    ...
    def setFace(self, face):
        if face in ['helvetica','arial','courier','times new roman','verdana', 'avenir','cormorant garamond']:
...
class Button:
    ...
    def __init__(self, win, topLeft, width, height, radius=0,
                 edgeWidth = 2, label = 'button caption',
                 buttonBG = 'lightgray', txtColor = 'black',
                 clickedBG = 'white', clickedTxtColor = 'black',
                 font=('courier',18,'normal'), timeDelay = 0.25):
        ...
        self.backcolor = buttonBG
        self.backcolorClicked = clickedBG

        if self.radius > 0:
            self.rect = RoundedRectangle(p1, p2, radius)
        else:
        ...
        self.forecolor = txtColor
        self.forecolorClicked = clickedTxtColor
        self.caption = Text(center, label, font[0], txtColor, font[1])
        #self.caption.setFace(font[0])
        #self.caption.setSize(font[1])
        self.caption.setStyle(font[2])
    ...
    def setClickedColors(self, newBG, newTxtColor):
        self.backcolorClicked = newBG
        self.forecolorClicked = newTxtColor
